...
ActiveRecord::Schema.define(version: 20170625173402) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.string   "lunchable_type",                  null: false
    t.integer  "lunchable_id",                    null: false
    t.boolean  "read",            default: false
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
    t.string   "sender_name"
    t.index ["conversation_id"], name: "index_messages_on_conversation_id", using: :btree
    t.index ["lunchable_type", "lunchable_id"], name: "index_messages_on_lunchable_type_and_lunchable_id", using: :btree
  end
